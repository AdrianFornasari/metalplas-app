        ...
        <div className="flex flex-wrap gap-2">
          {puedeIniciar && (
            <Button
              ...
              className="rounded-xl border-green-500 bg-green-100 px-3 py-2 text-sm font-bold text-green-950 hover:bg-green-200 hover:text-green-950"
            >
          ...
          {puedeSuspender && (
            <Button
              ...
              className="rounded-xl border-orange-500 bg-orange-100 px-3 py-2 text-sm font-bold text-orange-950 hover:bg-orange-200 hover:text-orange-950"
            >
          ...
          {puedeFinalizar && (
            <Button
              ...
              className="rounded-xl border-red-500 bg-red-100 px-3 py-2 text-sm font-bold text-red-950 hover:bg-red-200 hover:text-red-950"
            >
